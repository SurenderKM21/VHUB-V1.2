        ...
        public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
                return httpSecurity
                                ...
                                .authorizeHttpRequests(authorize -> authorize
                                                ...
                                                .hasAuthority("ROLE_Admin")
                                                .requestMatchers(HttpMethod.PUT, "/api/bookings/*/assign/*")
                                                .hasAuthority("ROLE_Admin")
                                                .requestMatchers(HttpMethod.POST, "/api/users/mechanic")
                                                .hasAuthority("ROLE_Admin")
                                                .requestMatchers(HttpMethod.PUT, "/api/users/*/role")
                                                .hasAuthority("ROLE_Admin")
                                                .requestMatchers(HttpMethod.PUT, "/api/bookings/*/status")
                                                .hasAnyAuthority("ROLE_Admin", "ROLE_Mechanic")
                                                .requestMatchers(HttpMethod.GET, "/api/bookings/mechanic")
                                                .hasAuthority("ROLE_Mechanic")
